...
if(isset($_POST['submit'])) 
{
     ...
     $sql="insert into parent(message,classname,username)values(?,?);";  
...
<form method="POST" class="w-full max-w-lg mx-auto p-4 bg-gray-100 rounded-xl">
  ...
  <div class="w-full md:w-full px-3 mb-6 md:mb-0">
      ...
      <input value="<?php echo $classname; ?>" required name="classname" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 <?php if($classnameerror)echo ' border-red-500'; ?> rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-user-name" type="text" placeholder="user name">
      <p class="mb-5 text-gray-600 <?php if($classnameerror)echo ' text-red-600'; ?> text-xs italic">User Name Must Be Uniqe</p>
    </div>
    <br>
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input value="<?php echo $message; ?>" required name="message" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="first name">
    </div>
